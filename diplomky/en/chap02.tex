...
An example of a classification model is in \autoref{fig:cls_model}.
...
The process of classification is broken down into four parts as shown in \autoref{fig:clsf_process}.
...
We will discuss this in \autoref{chap:fea}.
