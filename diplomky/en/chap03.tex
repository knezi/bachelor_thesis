...
For extracting entities, we used Geneea analyzer as described in \autoref{app:geneea}.
...
We use negative, neutral and positive sentiment extracted from the reviews by the Geneea analyzer.

\subsection{Cosine Similarity}

\textbf{Cosine similarity} is a measure of similiarity between two feature vectors.
