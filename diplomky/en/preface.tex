...
we describe linguistics analyser provided by Geneea Analytics.

In \textbf{\autoref{app:techn} Package Technicalities},
...
In \textbf{\autoref{app:mi} Top Features by Mutual Information},
