...
\jh{The entire configuration of experiments is specified in a separate file in YAML format. - 
Nelibi se mi to "This", zajmeno v textu by nemelo odkazovat k nadpisu sekce}
